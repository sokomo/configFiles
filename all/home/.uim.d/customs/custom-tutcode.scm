...
(define tutcode-personal-dic-filename "/home/sokomo/.mazegaki.dic")
...
(define tutcode-nr-candidate-max 40)
(define tutcode-nr-candidate-max-for-kigou-mode 95)
(define tutcode-nr-candidate-max-for-prediction 16)
(define tutcode-nr-candidate-max-for-guide 79)
(define tutcode-nr-candidate-max-for-history 40)
