...
(define generic-commit-key '("<IgnoreCase><Control>j" "return" "<IgnoreCase><Alt>z"))
(define generic-commit-key? (make-key-predicate '("<IgnoreCase><Control>j" "return" "<IgnoreCase><Alt>z")))
